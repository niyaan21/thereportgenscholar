...
export default function ResearchSummaryDisplay({ 
  ...
  return (
      <div>
        <Card className="w-full shadow-2xl border-primary/25 rounded-2xl overflow-hidden bg-card">
          ...
          <CardContent className="p-7 md:p-8 space-y-8">
            {originalQuestion && (
              <div className="p-6 bg-secondary/40 dark:bg-secondary/15 rounded-xl shadow-inner border border-border/70">
              ...
              {generatedImageUrl && !isGeneratingImage && (
                <div className="mt-4 border border-border/70 rounded-xl p-4 bg-secondary/30 dark:bg-secondary/10 shadow-lg relative group">
                  <div onClick={onOpenImagePreview} className="relative overflow-hidden rounded-lg cursor-pointer">
                        ...
                        width={700} 
                        height={400} 
                        className="rounded-lg object-contain mx-auto shadow-xl"
